    ...
    public static MauiApp CreateMauiApp()
    {
        ...
        builder
            ...
            .ConfigureFonts(fonts =>
            {
                ...
                fonts.AddFont("fa_pro_solid_900.otf", "FAS");
                fonts.AddFont("fa_pro_regular_400.otf", "FAR");
                fonts.AddFont("fa_pro_light_300.otf", "FAL");
                fonts.AddFont("MaterialIcons-Regular.ttf", "MaterialFontFamily");
                fonts.AddFont("icomoon.ttf", "MyAlias");
            ...
            .UseFFImageLoading()
            .UseBarcodeScanning()
            .ConfigureContainer(new MyServiceProviderFactory());
