...
namespace EZGO.Maui.Behaviors
{
    public class EventToCommandBehavior : BehaviorBase<View>
    {
        ...
        public static readonly BindableProperty IsEnabledProperty = BindableProperty.Create(nameof(IsEnabled), typeof(bool), typeof(EventToCommandBehavior), true);
        ...
        {
            if (Command == null || IsEnabled == false)
            {
                return;
            }
