...
public partial class LinearItemTemplate : Grid
{
	#region SkipCommand

    public static readonly BindableProperty SkipCommandProperty = BindableProperty.Create(nameof(SkipCommand), typeof(ICommand), typeof(LinearItemTemplate));
    ...
    public static readonly BindableProperty OkCommandProperty = BindableProperty.Create(nameof(OkCommand), typeof(ICommand), typeof(LinearItemTemplate));
    ...
    public static readonly BindableProperty NotOkCommandProperty = BindableProperty.Create(nameof(NotOkCommand), typeof(ICommand), typeof(LinearItemTemplate));
    ...
    public static readonly BindableProperty ActionCommandProperty = BindableProperty.Create(nameof(ActionCommand), typeof(ICommand), typeof(LinearItemTemplate));
    ...
    public static readonly BindableProperty DeepLinkCommandProperty = BindableProperty.Create(nameof(DeepLinkCommand), typeof(ICommand), typeof(LinearItemTemplate));
    ...
    public static readonly BindableProperty DetailCommandProperty = BindableProperty.Create(nameof(DetailCommand), typeof(ICommand), typeof(LinearItemTemplate));
    ...
    public static readonly BindableProperty IsScoreButtonVisibleProperty = BindableProperty.Create(nameof(IsScoreButtonVisible), typeof(bool), typeof(LinearItemTemplate));
    ...
    public static readonly BindableProperty OpenPopupCommandProperty = BindableProperty.Create(nameof(OpenPopupCommand), typeof(ICommand), typeof(LinearItemTemplate));
    ...
    public static readonly BindableProperty ScoreColorCalculatorProperty = BindableProperty.Create(nameof(ScoreColorCalculator), typeof(IScoreColorCalculator), typeof(LinearItemTemplate));
