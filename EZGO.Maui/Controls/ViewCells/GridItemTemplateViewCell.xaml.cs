...
public partial class GridItemTemplateViewCell : ViewCell
{
    #region SkipCommand

    public static readonly BindableProperty SkipCommandProperty = BindableProperty.Create(nameof(SkipCommand), typeof(ICommand), typeof(GridItemTemplateViewCell));
    ...
    public static readonly BindableProperty OkCommandProperty = BindableProperty.Create(nameof(OkCommand), typeof(ICommand), typeof(GridItemTemplateViewCell));
    ...
    public static readonly BindableProperty NotOkCommandProperty = BindableProperty.Create(nameof(NotOkCommand), typeof(ICommand), typeof(GridItemTemplateViewCell));
    ...
    public static readonly BindableProperty ActionCommandProperty = BindableProperty.Create(nameof(ActionCommand), typeof(ICommand), typeof(GridItemTemplateViewCell));
    ...
    public static readonly BindableProperty DeepLinkCommandProperty = BindableProperty.Create(nameof(DeepLinkCommand), typeof(ICommand), typeof(GridItemTemplateViewCell));
    ...
    public static readonly BindableProperty DetailCommandProperty = BindableProperty.Create(nameof(DetailCommand), typeof(ICommand), typeof(GridItemTemplateViewCell));
    ...
    public static readonly BindableProperty AreAdditionalButtonsVisibleProperty = BindableProperty.Create(nameof(AreAdditionalButtonsVisible), typeof(bool), typeof(GridItemTemplateViewCell), defaultValue: true, propertyChanged: OnAreAdditionalButtonsVisible);

    private static void OnAreAdditionalButtonsVisible(BindableObject bindable, object oldValue, object newValue)
    {
        var obj = bindable as GridItemTemplateViewCell;
    ...
    public static readonly BindableProperty OpenScorePopupProperty = BindableProperty.Create(nameof(OpenScorePopup), typeof(ICommand), typeof(GridItemTemplateViewCell));
    ...
    public static readonly BindableProperty IsScoreButtonVisibleProperty = BindableProperty.Create(nameof(IsScoreButtonVisible), typeof(bool), typeof(GridItemTemplateViewCell));
    ...
    public static readonly BindableProperty ScoreColorCalculatorProperty = BindableProperty.Create(nameof(ScoreColorCalculator), typeof(IScoreColorCalculator), typeof(GridItemTemplateViewCell));
    ...
    public GridItemTemplateViewCell()
    {
        InitializeComponent();
