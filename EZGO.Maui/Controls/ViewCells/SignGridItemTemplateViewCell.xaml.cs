...
public partial class SignGridItemTemplateViewCell : Grid
{
	public StageTemplateModel CurrentStage { get; set; }

	public static readonly BindableProperty SaveStageCommandProperty = BindableProperty.Create(nameof(SaveStageCommand), typeof(ICommand), typeof(SignGridItemTemplateViewCell));
	...
	public static readonly BindableProperty StageTemplateIdProperty = BindableProperty.Create(nameof(StageTemplateId), typeof(int?), typeof(SignGridItemTemplateViewCell), propertyChanged: OnStageIdPropertyChanged);
	...
	public static readonly BindableProperty IsListVisibleProperty = BindableProperty.Create(nameof(IsListVisible), typeof(bool), typeof(SignGridItemTemplateViewCell), propertyChanged: OnIsListVisiblePropertyChanged);
	...
	{
		var obj = bindable as SignGridItemTemplateViewCell;
		...
		MainThread.BeginInvokeOnMainThread(() =>
		{
			if (CurrentStage != null)
			{
				...
				if (CurrentStage.Signatures != null && CurrentStage.Signatures.Count > 0)
				{
					...
					{
						UserImage2.UserId = CurrentStage.Signatures[1].SignedById ?? 0;
	...
	public static readonly BindableProperty StagesProperty = BindableProperty.Create(nameof(Stages), typeof(StagesControl), typeof(SignGridItemTemplateViewCell), propertyChanged: OnStagesPropertyChanged);
	...
	public SignGridItemTemplateViewCell()
	{
		InitializeComponent();
		SetSignedGrid();
	...
	{
		var obj = sender as SignGridItemTemplateViewCell;
		obj.SetSignedGrid();
	}

	public static readonly BindableProperty IsSyncingProperty = BindableProperty.Create(nameof(IsSyncing), typeof(bool), typeof(SignGridItemTemplateViewCell), propertyChanged: OnIsSyncingPropertyChanged);
