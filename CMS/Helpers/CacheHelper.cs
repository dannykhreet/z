...
namespace WebApp.Helpers
{
    ...
    public static class CacheHelpers
    {
        ...
        public static MemoryCacheEntryOptions GetMemoryCacheDefaultEntryOptions()
        {
            ...
            cacheEntryOptions.AbsoluteExpirationRelativeToNow = TimeSpan.FromSeconds(3600);
        ...
        public static string GenerateCacheKey(string baseKey, int companyId, params object[] parameters)
        {
