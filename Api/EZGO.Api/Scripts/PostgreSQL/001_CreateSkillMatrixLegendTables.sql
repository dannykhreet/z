...
-- Drop new stored procedures (for re-running script)
DROP FUNCTION IF EXISTS public.get_matrix_legend_items(int4, varchar);
DROP FUNCTION IF EXISTS public.check_matrix_legend_exists(int4);
DROP FUNCTION IF EXISTS public.insert_matrix_legend_item(int4, int4, varchar, varchar, varchar, varchar, varchar, int4, int4, varchar, bool, int4);
DROP FUNCTION IF EXISTS public.update_matrix_legend_item(int4, int4, varchar, varchar, varchar, varchar, varchar, int4, int4, varchar, int4);
...
DROP TABLE IF EXISTS matrix_legend_item CASCADE;
...
CREATE OR REPLACE FUNCTION public.get_matrix_legend_items(_company_id integer, _skill_type varchar(20))
...
CREATE OR REPLACE FUNCTION public.check_matrix_legend_exists(_company_id integer)
 RETURNS boolean
 LANGUAGE plpgsql
 STABLE
AS $function$BEGIN
