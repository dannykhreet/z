...
namespace EZGO.Api.TaskGeneration.Helpers
{
    /// <summary>
    ...
    public static class StartupHelperExtension
    {
        ...
        public static void AddTaskGenerationServices(this IServiceCollection services)
        {
            services.AddScoped<ITaskGenerationManager, TaskGenerationManager>();
        }
    }
}
