...
namespace EZGO.WorkerService.Provisioner.Data
{
    public static class StartupHelperExtension
    {
        ...
        public static void AddProvisionerDataServices(this IServiceCollection services, IConfiguration configuration)
        {
