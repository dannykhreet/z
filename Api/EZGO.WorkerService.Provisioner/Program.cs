...
using EZGO.WorkerService.Provisioner.Data;
    ...
    public class Program
    {
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
           ...
           }).ConfigureServices((hostContext, services) =>
           {
               ...
               services.AddProvisionerDataServices(configuration); //Data Services, contains DI managers that are needed for the application. If a manager that is used for DI is added within the data library, add it to the services in this method.
               services.AddProvisionerServices();
