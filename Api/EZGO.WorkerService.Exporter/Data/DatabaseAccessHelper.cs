...
//{
//    /// <summary>
//    /// DatabaseAccessHelper; NOTE! NON SCOPED, OPENS CONNECTION FOR EACH METHOD.
//    /// </summary>
//    public class DatabaseAccessHelper : IDatabaseAccessHelper, IDisposable, IAsyncDisposable
//    {
//        private readonly IConnectionHelper _connectionHelper;
...
//        public NpgsqlConnection Connection { get { throw new NotImplementedException("Connection; Global connection is not implemented"); } set { throw new NotImplementedException("Connection; Global connection is not implemented"); } }
//        public NpgsqlConnection ReaderConnection { get { throw new NotImplementedException("ReaderConnection; Global connection is not implemented"); } set { throw new NotImplementedException("ReaderConnection; Global connection is not implemented"); } }
//        public NpgsqlConnection WriterConnection { get { throw new NotImplementedException("WriterConnection; Global connection is not implemented"); } set { throw new NotImplementedException("WriterConnection; Global connection is not implemented"); } }
...
//        {
//            await Task.CompletedTask;
//            throw new NotImplementedException("GetWriterConnection is not implemented");
//        }
...
//        {
//            await Task.CompletedTask;
//            throw new NotImplementedException("GetReaderConnection is not implemented");
//        }
...
//        /// <param name="commandType">CommandType (query or stored procedure).</param>
//        /// <returns>A Database command for further use.</returns>
//        public NpgsqlCommand GetCommand(NpgsqlConnection connection, string commandText, CommandType commandType)
//        {
//#pragma warning disable CA2100 // Review SQL queries for security vulnerabilities
...
//                    cmd = this.GetCommand(connection, "add_log", CommandType.StoredProcedure);
...
//                    if (string.IsNullOrEmpty(eventname))
//                    {
//                        cmd.Parameters.AddWithValue("@_eventname", "");
//                    }
//                    else
//                    {
//                        cmd.Parameters.AddWithValue("@_eventname", eventname);
//                    }
//                    if (string.IsNullOrEmpty(source))
//                    {
...
//                    else
//                    {
//                        cmd.Parameters.AddWithValue("@_source", source);
//                    }
