...
{
    /// <summary>
    /// SAPAction; Object posted to a SAP connector; This will probably be converted to JSON before posting; 
    ...
    public class SAPAction
    {
        ...
        /// </summary>
        public List<SAPActionComment> Comments { get; set; }

        /// <summary>
        /// SAPAction; Constructor, auto creates the properties that are lists.
        /// </summary>
        public SAPAction()
        {
            Comments = new List<SAPActionComment>();
