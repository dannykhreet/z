...
namespace EZGO.Api.Utils.Security
{
    ...
    /// Enables generation of twofactor codes, qrcodes and validated them. 
    /// NOTE! storing of TFA data is not part of this object, do not extend to DB or other related storage functionalities, this is only the 'util'.
    /// Storing of this information can be found in the UserProfileAuthorizationSettingsManager. 
    /// 
    /// Parts of this code stack is based on the open source GoogleAuthenticator (not related to google) project on GitHub:
    /// 
    /// Modified from
